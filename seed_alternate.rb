...
Monster.create(:description => "a runty-looking demon", :hp => 30, :ap => 3, :killed_by_player => false, :room_id => 14)
Monster.create(:description => "horrible demon baby", :hp => 40, :ap => 5, :killed_by_player => false, :room_id => 1)
Monster.create(:description => "axe-wielding enthusiastic work acquaintance", :hp => 100, :ap => 15, :killed_by_player => false, :room_id => 20)
Monster.create(:description => "fedora-clad code warrior", :hp => 120, :ap => 10, :killed_by_player => false, :room_id => 13)
Monster.create(:description => "sentient pile of laundry", :hp => 80, :ap => 5, :killed_by_player => false, :room_id => 4)
Monster.create(:description => "your blood-soaked grandmother", :hp => 180, :ap => 4, :killed_by_player => false, :room_id => 22)
Monster.create(:description => "the possessed corpse of your ex-lover", :hp => 100, :ap => 50, :killed_by_player => false, :room_id => 20)
Monster.create(:description => "warhorse-riding office jockey", :hp => 50, :ap => 10, :killed_by_player => false, :room_id => 16)
Monster.create(:description => "a tall dude wearing a hockey mask. He's trying a little too hard.", :hp => 50, :ap => 10, :killed_by_player => false, :room_id => )
Monster.create(:description => "Glampire David Bowie", :hp => 70, :ap => 8, :killed_by_player => false, :room_id => 5)
Monster.create(:description => "Ninja from Die Antwoord, dressed as an actual ninja", :hp => 15, :ap => 3, :killed_by_player => false, :room_id =>4 )
Monster.create(:description => "superstar producer Hit-Boi, who apparently moonlights as a Hit-Man", :hp => 30, :ap => 2, :killed_by_player => false, :room_id => 3)
Monster.create(:description => "a clone of yourself, if you were more muscular and attractive. And also a zombie.", :hp => 200, :ap => 10, :killed_by_player => false, :room_id => 11)
