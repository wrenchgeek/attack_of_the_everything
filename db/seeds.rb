...
Monster.create(:description => "Forever Alone Zombie", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 3)
Monster.create(:description => "The Zombie formerly known as Prince", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 5)
Monster.create(:description => "What's 'er Butt", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 6)
Monster.create(:description => "Zombie Christopher Walken (aka 'The Walken Dead')", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 7)
Monster.create(:description => "Willem Dafoe, as himself", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 8)
Monster.create(:description => "Zombie Jesus", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => 13)
Monster.create(:description => "Friendly Zombie", :hp => 20, :ap => 5, :killed_by_player => false, :room_id => 15)
Monster.create(:description => "Zombie Steve 1", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => nil)
Monster.create(:description => "Your Boss, not sure if zombie or not -- kill him/her anyway!", :hp => 80, :ap => 20, :killed_by_player => false, :room_id => nil)
Monster.create(:description => "A Zombie Called 'IT'", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => nil)
Monster.create(:description => "Zombie Steve 4", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => nil)
Monster.create(:description => "Zombie Steve 2", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => nil)
Monster.create(:description => "Zombie Steve 3", :hp => 40, :ap => 10, :killed_by_player => false, :room_id => nil)
