...
Room.create({:x_coordinate => 4, :y_coordinate => 4, :north => TRUE, :south => TRUE, :east => TRUE, :west => FALSE, :description => "You are in the hallway right outside of Dave's office.  It doesn't look like Dave put up much of a fight, he was not the athletic type."})
...
Room.create({:x_coordinate => 4, :y_coordinate => 3, :north => TRUE, :south => TRUE, :east => TRUE, :west => FALSE, :description => "You are in the hallway right outside of your office. There's blood and brains dripping from the wall."})
...
Room.create({:x_coordinate => 4, :y_coordinate => 2, :north => TRUE, :south => TRUE, :east => TRUE, :west => FALSE, :description => "You are in the hallway right outside of Rob's office. The rank scent of death is all around you."})
Room.create({:x_coordinate => 5, :y_coordinate => 2, :north => FALSE, :south => FALSE, :east => FALSE, :west => TRUE, :description => "You are in Rob's office. The contents of his man purse are strewn all over the place."})
