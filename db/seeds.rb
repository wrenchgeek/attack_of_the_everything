...
Monster.create(:description => "Zombie Steve 5", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 3)
Monster.create(:description => "Zombie Steve 6", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 5)
Monster.create(:description => "What's 'er Butt's Zombie", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 6)
...
Monster.create(:description => "Willem Dafoe, as himself", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 8)
Monster.create(:description => "Zombie Jesus", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 9)
Monster.create(:description => "Forever Alone Zombie", :hp => 20, :ap => 5, :killed_by_player => false, :attack_counter => 0, :room_id => 15)
...
Monster.create(:description => "The Zombie formerly known as Prince", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 18)
Monster.create(:description => "Zombie Steve 8", :hp => 40, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 19)
Monster.create(:description => "Zombie Steve Infinity", :hp => 100, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 21)
...
Monster.create(:description => "Zombie Vampire", :hp => 100, :ap => 10, :killed_by_player => false, :attack_counter => 0, :room_id => 24)
