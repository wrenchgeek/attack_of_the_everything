...
Room.create({:x_coordinate => 1, :y_coordinate => 3, :north => TRUE, :south => TRUE, :east => TRUE, :west => FALSE, :description => "THE EXIT!!! IT'S RIGHT THERE!!! RIGHT IN FRONT OF YOUR STUPID FACE!!!"})
...
Room.create({:x_coordinate => 2, :y_coordinate => 2, :north => FALSE, :south => TRUE, :east => FALSE, :west => TRUE, :description => "You are at the water cooler. There is nobody to talk to about last nights Game of Thrones episode."})
...
Room.create({:x_coordinate => 0, :y_coordinate => 3, :north => FALSE, :south => FALSE, :east => FALSE, :west => FALSE, :description => "YOU'VE DONE IT!!! You've finally made it out of that hellhole. You have no idea what awaits you outside, but you can take solice in the fact that you never have to go to work again."})
